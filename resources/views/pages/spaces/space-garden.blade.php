    ...
    <div class="flex flex-col lg:flex-row gap-8">
        <div class="lg:w-4/6">
            ...
            <h1 class="text-3xl md:text-4xl font-extrabold mb-6 break-words">
                Under the Canopy of Our Lush, Green Garden
            </h1>

            <div class="mb-8">
                <img src="{{ asset('img/item-facilities/canopy-lush-garden.jpg') }}" alt="Under the Canopy of Our Lush, Green Garden"
                     class="w-full h-96 object-cover shadow-sm">
            </div>
            <div class="prose max-w-none text-[#4E3D33] leading-relaxed text-lg">
                Istirahat sejenak dengan tenang di bawah taman rooftop kami yang nyaman, dikelilingi tanaman hijau dan suara gemericik kolam ikan yang menenangkan hati.
            </div>
        </div>
        ...
        <div class="w-2/6 min-h-[20rem] bg-[#FCECB9] m-8 p-6 h-fit space-y-3">
            ...
            <p class="font-bold break-words space-y-1">
                ...
                <a class="text-[#3D9BEF]" href="{{ route('space.garden') }}">Lush Green Garden</a><br>
