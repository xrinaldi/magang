...
<div class="container mx-auto px-4 py-8 md:py-12">
    <div class="flex flex-col lg:flex-row gap-8">
        <div class="lg:w-4/6">
            ...
            <div class="mb-8">
                <img src="{{ asset('img/promos/specialmenu-landscape.png') }}" alt="Promo Special Menu"
                     class="w-full h-96 object-cover shadow-sm">
            </div>
            <div class="prose max-w-none text-[#4E3D33] leading-relaxed text-lg">
                Khusus pembelian signature menu kami, kamu berhak mendapatkan diskon hingga 30%. Syarat dan ketentuan bisa ditanyakan di kasir. Jangan malu untuk bertanya!
            </div>
        </div>
        ...
        <div class="w-2/6 min-h-[20rem] bg-[#FCECB9] m-8 p-6 h-fit space-y-3">
            ...
            <p class="font-bold break-words space-y-1">
                ...
                <a class="text-[#3D9BEF]" href="{{ route('promo.specialmenu') }}" class="hover:underline">Promo Special Menu</a>
            </p>
        </div>
    </div>
</div>
