        ...
        <div class="blog-container">
            ...
            <article class="blog-card">
                <div class="blog-image">
                    ...
                    @else
                        @php
                            // Gambar placeholder berbeda untuk setiap artikel
                            $placeholders = [
                                'https://apps.codepolitan.com/sites/learn/uploads/original/202308/10+_Cara_Meningkatkan_Keamanan_Website___Proteksi_Lengkap!.png',
                            ...
                            $index = $key % count($placeholders);
                        @endphp
                        <img src="{{ $placeholders[$index] }}" alt="{{ $article->title }}">
                    @endif
                </div>
                <div class="blog-content">
                    <div class="blog-date">{{ \Carbon\Carbon::parse($article->publish_date)->format('d F Y') }}</div>
                    <h3>{{ $article->title }}</h3>
